# polylang-form-translations Specification

## Purpose
Defines the expected behavior for native Polylang translation support in Fluent Forms: boot safety, global and per-form string registration, runtime translation, and language-aware request handling.
